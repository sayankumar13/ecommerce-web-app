...
const Payment = ({history}) => {
  ...
  return (
    <>
      ...
      <div className="payment__box" style={{
        ...
        <div className="bkash__box">
          <div className="bkash__box__inline" style={{width:"40%",backgroundColor:"#E21D60",padding:"1vmax",justifyContent:"center",display:"flex",flexDirection:"column"}}>
            <div style={{justifyContent:"center",width:"100%",display:"flex"}}>
          <img src="https://raw.githubusercontent.com/Shipu/bkash-example/master/bkash_payment_logo.png" style={{width:"80%"}} />
            </div>
           <div>
